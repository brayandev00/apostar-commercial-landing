    ...
    <section id="juegos" className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 text-balance">Juegos Disponibles</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Conoce todos los juegos que puedes ofrecer a tus clientes y las comisiones que recibirás por cada venta.
          </p>
        </div>
